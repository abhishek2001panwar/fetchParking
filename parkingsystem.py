...
#         print("2. Occupy a Slot (Driver only)")
#         print("3. Release a Slot (Driver only)")
#         print("4. Exit")
        
#         role = input("Enter your role (Driver/Parking Agent/Central Agent): ").strip()
...
#             print("Available Slots:", [slot['slot_id'] for slot in available_slots])
        
#         elif choice == "2":
#             if role != "Driver":
#                 print("Only drivers can occupy slots.")
#                 continue
#             try:
#                 slot_id = int(input("Enter the slot ID to occupy: "))
#                 response = requests.post("http://127.0.0.1:8000/occupy_slot", json={"slot_id": slot_id}, params={"role": role})
#                 if response.status_code == 200:
#                     print(f"Slot {slot_id} has been occupied.")
#                 else:
#                     print("Error:", response.json().get("detail", "Slot not available."))
#             except ValueError:
#                 print("Invalid input. Please enter a valid slot ID.")
        
#         elif choice == "3":
#             if role != "Driver":
#                 print("Only drivers can release slots.")
#                 continue
#             try:
#                 slot_id = int(input("Enter the slot ID to release: "))
#                 response = requests.post("http://127.0.0.1:8000/release_slot", json={"slot_id": slot_id}, params={"role": role})
#                 if response.status_code == 200:
#                     print(f"Slot {slot_id} has been released.")
#                 else:
#                     print("Error:", response.json().get("detail", "Slot not occupied."))
#             except ValueError:
#                 print("Invalid input. Please enter a valid slot ID.")
